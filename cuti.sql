...
--
-- Host: localhost:3306
-- Generation Time: Oct 03, 2025 at 06:34 AM
...
--
ALTER TABLE `pegawai`
  ADD CONSTRAINT `pegawai_ibfk_1` FOREIGN KEY (`id_pegawai`) REFERENCES `cuti` (`id_pegawai`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
